...
public class Level2Boss1 : MonoBehaviour {
    public Camera cam;
    ...
    void Start() {
        ...
        skullWidth = orangeSkull.GetComponent<Renderer>().bounds.extents.x;
        skullHeight = orangeSkull.GetComponent<Renderer>().bounds.extents.y;
